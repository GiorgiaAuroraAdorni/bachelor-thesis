...
\begin{center}
	\vspace{40mm}
	\doublespacing\textbf{\Huge APPRENDIMENTO DELLA PERSONALITÀ BASATO SUL LINGUAGGIO NATURALE }\\
\end{center}
...
\begin{tabular}{ll}
	\textbf{Relatore: } & {Stella Fabio Antonio}\\
	\textbf{Co-relatore: } & {Marelli Marco}
\end{tabular}
